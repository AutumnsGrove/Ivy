		...
		'3': [
			{
				...
				to: [{ name: 'You', email: 'user@grove.place' }, { name: 'Jordan Miller', email: 'jordan@grove.place' }],
...
<p>Alex</p>`,
			...
			},
			{
				...
				to: [{ name: 'Alex Chen', email: 'alex@grove.place' }, { name: 'You', email: 'user@grove.place' }],
...
<p>Jordan</p>`,
			...
			},
			{
				...
				to: [{ name: 'Alex Chen', email: 'alex@grove.place' }, { name: 'Jordan Miller', email: 'jordan@grove.place' }],
		...
		{#each messages as message, i (message.id)}
			<article class="message" class:collapsed={message.isCollapsed}>
				<button class="message-header" onclick={() => message.isCollapsed = !message.isCollapsed}>
					...
					<Icon name={message.isCollapsed ? 'chevron-right' : 'chevron-down'} size={16} class="expand-icon" />
				</button>
